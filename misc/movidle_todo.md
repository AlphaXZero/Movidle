...
- [ ] Stocker les films dans une db (update chaqe jour avec l'api) pour éviter les appels API répétés et permettre l'autocomplete (utiliser tmdb à la place pour mettre à jour la db chaque jour) (tmdb > omdb)
...
- [ ] Enlever AppState.Username car inutile ? évite recherche dans db à voir
- [ ] togglefavorite au lieu de add et remove ?
